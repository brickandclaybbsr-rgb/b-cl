    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between pb-1">
        ...
        <div className="flex gap-2">
          ...
          >
            <Wallet className="size-3.5" /> Closing Balance
          </Link>
          <Link
            href="/owner/export-report"
            className="flex items-center gap-1.5 rounded-lg bg-white px-3 py-2 text-xs font-bold text-black transition-opacity hover:opacity-90"
          >
            Export PDF
          </Link>
        </div>
